...
public class LoginActivity extends AppCompatActivity{
    ...
    private static final String TAG3 = "GoogleActivity";
    private static final String TAG4 = "EmailActivity";
                            ...
                            .addOnCompleteListener(LoginActivity.this, new OnCompleteListener<AuthResult>() {
                                ...
                                public void onComplete(@NonNull Task<AuthResult> task) {
                                    if (task.isSuccessful()) {
                                        ...
                                        Log.d(TAG4, "createUserWithEmail:success");
...
//        LOGIN WITH TWITTER
        ...
        twitterLogin.setCallback(new Callback<TwitterSession>() {
            ...
            public void success(Result<TwitterSession> result) {
                ...
                Toast.makeText(LoginActivity.this, "Logged In With Twitter", Toast.LENGTH_LONG).show();
        ...
        //END LOGIN WITH TWTTIER
        //LOGIN WITH FB
//         Initialize Facebook Login button
        mCallbackManager = CallbackManager.Factory.create();
        LoginButton fbLog = findViewById(R.id.fb_login);
        fbLog.setReadPermissions("email", "public_profile");
        fbLog.registerCallback(mCallbackManager, new FacebookCallback<LoginResult>() {
            @Override
        ...
        //START GOOGLE LOGIN
        // [START config_signin]
        G_login = (SignInButton) findViewById(R.id.G_login);
        ...
        G_login.setOnClickListener(new OnClickListener() {
            @Override
...
//     [START auth_with_google]
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Log.d(TAG, "signInWithCredential:success");
                            FirebaseUser user = mAuth.getCurrentUser();
                            Toast.makeText(LoginActivity.this,"Signed in with Google",Toast.LENGTH_LONG).show();
                        } else {
                            // If sign in fails, display a message to the user.
                            Log.w(TAG, "signInWithCredential:failure", task.getException());
                            Toast.makeText(LoginActivity.this, "Authentication failed.",
    ...
    //    //revoking access to google FOR LATER
